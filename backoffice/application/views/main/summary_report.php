                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $this->lang->line("summary_report"); ?> </h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <br>
                                        <table class="table" id="summary_report_dt">
                                            <thead>
                                                <tr>
                                                    <th>Agent</th>
                                                    <th>Upline</th>
...
<script type="text/javascript">
	...
	function drawtable(month, year){
        var month = $("#month").val();
        var year = $("#year").val();
		$('#summary_report_dt').dataTable().fnClearTable();
    	$('#summary_report_dt').dataTable().fnDestroy();
        $('#summary_report_dt').DataTable({
            'dom': 'lBfrtip',
            'buttons': [
                {
                    extend: 'excelHtml5',
            ...
            'ajax': {
                'url': address + "Report/get_summary_report",
                "type": "POST",
                "data": {
            ...
            "columns": [
                ...
                {"data": "referral_name", "orderable": false},
