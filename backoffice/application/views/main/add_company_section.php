                        ...
                        <form method="POST" id="company_section_form">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><?php echo $this->lang->line("add_company_section"); ?></h4>
                                </div>
...
<script>
    $("#back").click(function(){
        window.location.href = "<?= site_url(); ?>Company/about";
    });
