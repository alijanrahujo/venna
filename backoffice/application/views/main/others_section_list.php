                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $this->lang->line("other_section"); ?> <a href="<?= site_url(); ?>Company/othersa"><i class="fa fa-plus-circle add-icon"></i></a></h4>
                            </div>
        ...
        if (confirm("<?php echo $this->lang->line("are_you_sure_you_want_to_delete"); ?> ?")) {
            ...
            .then(function (response) {
                if(response.data.status == "Success"){
                    success_response_with_timer('<?php echo $this->lang->line("delete_success"); ?>', true, 'Company/others');
                }else{
