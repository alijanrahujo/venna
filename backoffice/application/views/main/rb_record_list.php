                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $this->lang->line("rb_record"); ?></h4>
                            </div>
                            <div class="card-content ">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="rb_record_dt">
                                            <thead>
                                                <tr>
...
<script type="text/javascript">
	...
	function drawtable(){
		$('#rb_record_dt').dataTable().fnClearTable();
    	$('#rb_record_dt').dataTable().fnDestroy();
        $('#rb_record_dt').DataTable({
            'order': [],
            'serverSide': true,
            "bStateSave": true,
            ...
            'ajax': {
                'url': address + "Bonus/get_rb_record",
                "type": "POST",
                "data": {
