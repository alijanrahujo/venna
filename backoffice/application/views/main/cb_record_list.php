                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">CB Record</h4>
                            </div>
                            <div class="card-content ">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="cb_record_dt">
                                            <thead>
                                                <tr>
...
<script type="text/javascript">
	...
	function drawtable(){
		$('#cb_record_dt').dataTable().fnClearTable();
    	$('#cb_record_dt').dataTable().fnDestroy();
        $('#cb_record_dt').DataTable({
            'order': [],
            'serverSide': true,
            "bStateSave": true,
            ...
            'ajax': {
                'url': address + "Bonus/get_cb_record",
                "type": "POST",
                "data": {
