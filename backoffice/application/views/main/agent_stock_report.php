                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $this->lang->line("agent_stock_report"); ?> </h4>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <button class="btn btn-primary" type="button" onclick="drawtable()">Submit</button>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        <br>
                                        <table class="table" id="agent_stock_report_dt">
                                            <thead>
                                                <tr>
...
<script type="text/javascript">
    ...
    function search_agent_stock_report(){
        var month = $("#month").val();
        var year = $("#year").val();
	...
	function drawtable(month, year){
        var month = $("#month").val();
        var year = $("#year").val();
		$('#agent_stock_report_dt').dataTable().fnClearTable();
    	$('#agent_stock_report_dt').dataTable().fnDestroy();
        $('#agent_stock_report_dt').DataTable({
            'dom': 'lBfrtip',
            'buttons': [
                {
                    extend: 'excelHtml5',
                    title: 'Monthly Agent Stock Report',
            ...
            'ajax': {
                'url': address + "Report/get_agent_stock_report",
                "type": "POST",
                "data": {
