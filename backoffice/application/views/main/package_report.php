                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $this->lang->line("package_report"); ?></h4>
                            </div>
                            <div class="card-content ">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table" id="package_report_dt">
                                            <thead>
                                                <tr>
                                                    <th><?php echo $this->lang->line("country"); ?></th>
                                                    <th><?php echo $this->lang->line("name"); ?></th>
                                                    <th>Total <?php echo $this->lang->line("agent"); ?></th>
                                                    <th>Monthly <?php echo $this->lang->line("agent"); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody></tbody>
                                        </table>
...
<script type="text/javascript">
	...
	function drawtable(){
		$('#package_report_dt').dataTable().fnClearTable();
    	$('#package_report_dt').dataTable().fnDestroy();
        $('#package_report_dt').DataTable({
            'dom': 'Bfrtip',
            'buttons': [
                {
                    extend: 'excelHtml5',
            ...
            'ajax': {
                'url': address + "Report/get_package_report",
                "type": "POST",
                "data": {
            ...
            "columns": [
                ...
                {"data": "total_package", "orderable": false},
                {"data": "monthly_package_total", "orderable": false}
            ]
        });
