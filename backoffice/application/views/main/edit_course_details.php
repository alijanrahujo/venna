                ...
                <div class="row">
                    <div class="col-12">
                        <form method="POST" id="course_details_form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="embed_url" name="embed_url" value="<?php echo $edit['embed_url']; ?>">
                                                </fieldset>
                                            </div>
                                        </div>
                                        <br>
                            ...
                            ?>
                            <input type="hidden" id="course_details_id" name="course_details_id" value="<?php echo $edit['id']; ?>">
                        </form>
                    </div>
                </div>
            </section>
...
<script>
    ...
    $('#course_details_form').submit(function(e) {
        ...
        var update_course_details = new FormData(this);
        update_course_details.set('access_token', $("#access_token").val());
        update_course_details.set('insert_by', $("#insert_by").val());

        axios.post(address + 'Course/update_course_details' , update_course_details, apiHeader)
