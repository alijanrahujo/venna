                            ...
                            <div class="col-12" id="activity">
                                ...
                                <div class="timeline-left timeline-wrapper mb-3" id="timeline-1">
                                    <ul class="timeline">
                                        ...
                                        <li class="timeline-item">
                                            <div class="timeline-badge"><span class="bg-primary bg-lighten-4" data-toggle="tooltip" data-placement="right" title="Portfolio project work"><img class="avatar" src="<?= site_url(); ?>library/img/portrait/small/avatar-s-15.png" alt="avatar" width="40"></span></div>
                                            <div class="activity-list-text">
                                        ...
                                        <li class="timeline-item">
                                            <div class="timeline-badge"><span class="bg-primary bg-lighten-4" data-toggle="tooltip" data-placement="right" title="Portfolio project work"><img class="avatar" src="<?= site_url(); ?>library/img/portrait/small/avatar-s-16.png" alt="avatar" width="40"></span></div>
                                            <div class="activity-list-text">
                                                ...
                                                <div class="notification-note">
                                                    <div class="p-1 pl-2"><img src="<?= site_url(); ?>library/img/icons/sketch-mac-icon.png" alt="icon" width="20"><span class="text-bold-500 ml-2">Diamond.sketch</span></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="timeline-item">
                                ...
                                <div class="timeline-left timeline-wrapper" id="timeline-2">
                                    <ul class="timeline">
                                        <li class="timeline-line mt-4"></li>
                                        <li class="timeline-item">
                                            <div class="timeline-badge"><span class="bg-primary bg-lighten-4" data-toggle="tooltip" data-placement="right" title="Portfolio project work"><img class="avatar" src="<?= site_url(); ?>library/img/portrait/small/avatar-s-26.png" alt="avatar" width="40"></span></div>
                                            <div class="activity-list-text">
                                                ...
                                                <div class="notification-note">
                                                    <div class="p-1 pl-2"><img src="<?= site_url(); ?>library/img/icons/pdf.png" alt="pdf icon" width="20"><span class="text-bold-500 ml-2">Register.pdf</span></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="timeline-item">
                                        ...
                                        <li class="timeline-item">
                                            <div class="timeline-badge"><span class="bg-primary bg-lighten-4" data-toggle="tooltip" data-placement="right" title="Portfolio project work"><img class="avatar" src="<?= site_url(); ?>library/img/portrait/small/avatar-s-23.png" alt="avatar" width="40"></span></div>
                                            <div class="activity-list-text">
    ...
    <footer class="footer undefined undefined">
        <?php
            ...
            if($company_id == 0){
                $footer_text = "TIANZ ACADEMY SDN BHD";
            }else{
                $company_info = $this->Api_Model->get_rows_info(TBL_COMPANY, "id, footer_text", array('id' => $company_id, 'active' => 1));
                $footer_text = isset($company_info['id']) ? $company_info['footer_text'] : "TIANZ ACADEMY SDN BHD";
            }
        ?>
        <p class="clearfix text-muted m-0"><span>COPYRIGHT &copy; 2021 &nbsp;</span><a><?php echo $footer_text; ?> </a><span class="d-none d-sm-inline-block"> ALL RIGHTS RESERVED.</span></p>
    </footer>
    <!-- End : Footer-->
    ...
    <script src="<?= site_url(); ?>library/vendors/js/sweetalert2.all.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/jquery.dataTables.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/dataTables.bootstrap4.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/dataTables.buttons.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/buttons.html5.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/buttons.print.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/jszip.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/pdfmake.min.js"></script>
    <script src="<?= site_url(); ?>library/vendors/js/datatable/vfs_fonts.js"></script>
    <script src="<?= site_url(); ?>library/js/data-tables/dt-advanced-initialization.js"></script>
    ...
    <script src="<?= site_url(); ?>library/textarea/summernote.min.js"></script>
	<script src="<?= site_url(); ?>library/vendors/js/select2.full.min.js"></script>
    <script src="<?= site_url(); ?>library/js/select2.min.js"></script>
    <!-- <script src='https://cdn.datatables.net/1.10.5/js/jquery.dataTables.min.js'></script> -->
    <!-- <script src='https://cdn.datatables.net/plug-ins/f2c75b7247b/integration/bootstrap/3/dataTables.bootstrap.js'></script> -->
    <script src='https://cdn.datatables.net/responsive/1.0.4/js/dataTables.responsive.js'></script>
    <script src="<?= site_url(); ?>library/js/jstree.min.js"></script>
</body>
</html>