      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Shipment History</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Shipment History</h6>
        </nav>
...
<div class="table-responsive">
  ...
  <tbody>
        <tr>
          <td>#0003696</td>
          <td><img src="https://v2lokoml0a-flywheel.netdna-ssl.com/wp-content/uploads/2016/01/chips-packaging-01.jpg" width="50px"></td>
